...
BoardSelector1::BoardSelector1(int number, QWidget *parent) : QWidget(parent)
{
    QString title = "board #";
...
BoardSelector2::BoardSelector2(int number, QWidget *parent) : QWidget(parent)
{
    board = new Board2;
...
BoardSelector3::BoardSelector3(int number, QWidget *parent) : QWidget (parent)
{
    board = new Board3;
...
BoardSelector4::BoardSelector4(int number, QWidget *parent) : QWidget (parent)
{
    board = new Board4;
